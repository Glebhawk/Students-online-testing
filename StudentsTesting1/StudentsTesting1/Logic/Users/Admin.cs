...
namespace StudentsTesting1.Logic.Users
{
    public class Admin : User
    {
        ...
        public IoCContainer IoC { get; set; } = new IoCContainer(); 
        public IDBAccess dbAccess { get; set; }
        public TeacherAccess teacherAccess { get; set; }
        public SubjectAccess subjectAccess { get; set; }
        ...
        public void CreateSubject(string title, Teacher teacher)
        {
            ...
            subjectAccess.InsertSubjectToDB(IoC.ResolveObject(typeof(Subject), param) as Subject, teacher.teacherID);
        }

        public void CreateGroup(string title)
        {
            List<object> param = new List<object> { title };
            groupAccess.InsertGroupToDB(IoC.ResolveObject(typeof(Group), param) as Group);
        }
