...
namespace StudentsTesting1.DataAccess
{
    public class ResultAccess
    {
        ...
        public void InsertResultToDB(Result result, int examId, string studentID)
        {
        ...
        public List<Result> GetResultsOfGroup(string groupTitle, int examId)
        {
        ...
        public Result GetResultOfStudent(string studentID, int examID)
        {
